 ...
 const handleLogout = () => {
  ...
  return (
      <Transition.Root show={props.openLogoutAlert} as={Fragment} >
        <Dialog as="div" className="relative" initialFocus={cancelButtonRef} onClose={() => props.setOpenLogoutAlert(false)}>
          <Transition.Child
            as={Fragment}
          ...
          <div className="fixed inset-0 z-10 w-screen ">
            <div className="flex backdrop-blur-md min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
              <Transition.Child
                as={Fragment}
                enter="ease-out duration-300"
                ...
                <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                  ...
                  <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                    ...
                    <button
                      ...
                      onClick={() => props.setOpenLogoutAlert(false)}
                      ref={cancelButtonRef}
                    >
                      Cancelar
                    </button>
